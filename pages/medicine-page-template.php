        ...
        <div class="card">
          ...
          <header class="card__header">
            ...
            <p class="card__subtitle">
              ...
              nasıl kullanılır?
              <?php echo $medicine['name']; ?>
              ilacının yan etkileri ve kullanırken dikkat edilmesi gerekenler
              nelerdir?
            </p>
          </header>
          ...
          <div class="comment-container">
            <div class="comment__form">
              ...
              <form action="" method="post" class="form">
                ...
                <!-- button -->
                <button type="submit" class="submit-btn" name="post_comment">
                  Submit
                </button>
              </form>
            </div>
            ...
            <div class="posted-comments">
              ...
              <?php
                ...
                $resultComments = $link->query($sqlComments); if
              ($resultComments->num_rows > 0) { while ($row =
              $resultComments->fetch_assoc()) { ?>
              <div class="posted-comment__body">
                <h2 class="posted-comment__name">
                  <?php echo $row  ['name'];?>
                </h2>
                <p class="posted-comment__text">
